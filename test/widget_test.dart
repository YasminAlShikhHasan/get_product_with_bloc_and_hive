...
import 'package:api_with_bloc/main.dart';
...
void main() {
  ...
  test('The map has one entry', () {
    expect(replaceUrlFromMap(url, {'score': '30'}),
        'www.google.com/api/{name}/hello/30');
  });
  test('The link is empty', () {
    expect(replaceUrlFromMap(url, mapForTest), url);
  });
}
